...
const PrivacyPolicy = () => {
	return (
		<article class=" center avenir w-90">
			{/* <span class="f2 center">Privacy Policy & Terms and Conditions</span> */}
			<Heading
				animationData={animationData}
				content="Privacy Policy"
			/>
		
			<p class=" lh-copy center">
			...
			<span class=" lh-copy center">Topics:</span>
			<ul>
			...
			<p class=" lh-copy center">What information do I collect about you?</p>
			<p class=" lh-copy center">
			...
			<p class=" lh-copy center">How will I use the information about you?</p>
			<p class=" lh-copy center">
			...
			<p class=" lh-copy center">I use your information to:</p>
			<ul>
			...
			<p class=" lh-copy center">Access to your information and corrections</p>
			<p class=" lh-copy center">
			...
			<p class=" lh-copy center">Cookies</p>
			<p class=" lh-copy center">
			...
			<p class=" lh-copy center">Other websites</p>
			<p class=" lh-copy center">
			...
			<p class=" lh-copy center">Changes to my privacy policy</p>
			<p class=" lh-copy center">
